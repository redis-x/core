...
export interface IncrbyfloatSchema extends BaseSchema {
	args: [ 'INCRBYFLOAT', string, string ];
 ...
 */
export function INCRBYFLOAT(key: string, increment: number): IncrbyfloatSchema {
	return {
		kind: '#schema',
		args: [
			'INCRBYFLOAT',
