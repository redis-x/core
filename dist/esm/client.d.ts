...
export declare class RedisXClient extends RedisXClientBase {
     ...
     * @returns The value associated with the field or `null` when the field is not present in the hash or key does not exist.
     */
    HMGET(key: string, fields: string[] | Set<string>): Promise<Record<string, string | null>>;
    /**
     ...
     */
    ZRANGE(key: string, start: number | string, stop: number | string, options: ZrangeOptionsWithWithscores): Promise<{
        value: string;
        score: number;
    }[]>;
    /**
     ...
     */
    PEXPIRE(key: string, seconds: number, options?: PexpireOptions): Promise<0 | 1>;
    /**
